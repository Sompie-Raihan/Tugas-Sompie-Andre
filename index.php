...
<body>
  ...
  <section id="hero" class="d-flex flex-column justify-content-center align-items-center">
    <div class="container text-center text-md-left" data-aos="fade-up">
      <h1>Welcome to <span>Kursus-Inti</span></h1>
      <h2>Fail-Learn-Repeat</h2>
      <a href="#kursus" class="btn-get-started scrollto">Get Started</a>
    </div>
  </section><!-- End Hero -->
  ...
  <main id="main">
    ...
    <!-- ======= Portfolio Section ======= -->
    <section id="kursus" class="portfolio">
      <div class="container">
        ...
        <?php $DATA = mysqli_query($KONEKSI,"SELECT * FROM tbl_kursus ORDER BY id_kursus ASC ");
               $NO = 0;
                ...
                ?>
                <?php $GAM = $KURSUS['gambar']?>
                <div class="col-lg-4 col-md-6 portfolio-item filter-app wow fadeInUp">
            <div class="portfolio-wrap">

            
            <a href="detail_kursus.php?id_kursus=<?php echo $KURSUS['id_kursus']?>" class="link-details" title="More Details"><img src="<?php if($KURSUS['gambar'] == ""){echo "./assets/img/portfolio/Default.jpg";} else {echo "./assets/img/portfolio/$GAM";}?>" class="img-fluid" alt="Missing pic"></a>
              <div class="portfolio-info">
                <h4><a href="detail_kursus.php?id_kursus=<?php echo $KURSUS['id_kursus']?>"><?php echo $KURSUS['nama_kursus'] ?></a></h4>
                <p>Jumlah Chapter :<strong><?php echo $KURSUS['jumlah_chp']?></strong></p>
                <p>Harga Kursus:<strong><?php echo $KURSUS['harga_kursus']?> RP</strong></p>
              </div>
            </div>
          </div>
